...
<div class="card shadow bg-white">
	...
	<div class="card-footer">
			<div class="row">
				<div class="col-sm-11">
					<a href="index.php?halaman=edit_produk&idproduk=<?php echo $detail_produk['id_produk']; ?>&idfoto=<?php echo $produkfoto['id_produk_foto'] ?>" class="btn btn-sm btn-primary">Edit Produk</a>
				</div>
